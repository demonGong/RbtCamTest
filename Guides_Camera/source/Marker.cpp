...
void MTMarker::Marker::tooltip2MarkerXfSet(Xform3D* tooltip2Mark)
{
	mtHandle XformHandle = tooltip2Mark->getHandle();
	int result = Marker_Tooltip2MarkerXfSet(this->getHandle(),XformHandle);
}
