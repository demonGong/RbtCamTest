...
#define MTCBuild 6
#define MTCRevision 5
#define MTCVERSION_STR "3, 7, 6, 5"
...
EXT mtCompletionCode CCONV Markers_AutoAdjustHdrExposureLockMarkersGet(bool *p_out);
EXT mtCompletionCode CCONV Markers_AutoAdjustHdrExposureLockMarkersSet(bool p_out);
